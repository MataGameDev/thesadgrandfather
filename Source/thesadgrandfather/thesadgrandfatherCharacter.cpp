...
//////////////////////////////////////////////////////////////////////////
// AthesadgrandfatherCharacter

AthesadgrandfatherCharacter::AthesadgrandfatherCharacter()
{
...
void AthesadgrandfatherCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AthesadgrandfatherCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AthesadgrandfatherCharacter::Move);
...
void AthesadgrandfatherCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AthesadgrandfatherCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
